...
const Comments = ({ review }) => {
  ...
  return (
    <CommentsComponent>
      {review.comments && review.comments.map((comment, index) => <Comment comment={comment} key={index} />)}
      <FormComponent onSubmit={onSubmit}>
        <input ref={inputRef} type="text" value={text} onChange={setTextValue} placeholder="댓글을 입력해주세요." />
